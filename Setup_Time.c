...
void Increase_Time()
{
            switch (Select_Field)               // Increment the proper field
            {
                case 0:
                    setup_hour++;
                    if (setup_hour > 23) setup_hour = 0; 
                    break;
                case 1:
                    setup_minute++;
                    if (setup_minute > 59) setup_minute = 0; 
                    break;
                case 2:
                    setup_second++;
                    if (setup_second > 59) setup_second = 0; 
                    break;
                case 3:
                    setup_month++;
                ...
                case 4:
                    setup_day++;
                    if (setup_day > 30) setup_day = 1; 
                    break;  
                case 5:
                    setup_year++;
                    if (setup_year > 98) setup_year = 0;
                    break;
                default:
                    break;
            }    
...
void Decrease_Time()
{
            ...
            {
                case 0:
                    if (setup_hour < 1) setup_hour = 23;
                    else --setup_hour;
                    break;
                case 1:
                    if (setup_minute < 1) setup_minute = 59;
                    else --setup_minute;
                    break;
                case 2:
                    if (setup_second < 1) setup_second = 59;
                    else --setup_second;
                    break;
                case 3:
                    if (setup_month < 2) setup_month = 12; 
                    else --setup_month;
                    break;
                case 4:
                    if (setup_day < 2) setup_day = 30;
                    else --setup_day;
                    break;  
                case 5:
                    if (setup_year < 1) setup_year = 99;
                    else --setup_year;
                    break;
                default:
                    break;
